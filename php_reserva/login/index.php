...
<div class="container text-center mt-5">
  <h1 class="mt-3">Reserva de materiales </h1>
  <h5 class="mt-3">Porfavor Ingrese o Registrese</h5>
  <p class="mt-3"><a href="login.php">Ingresar</a> o <a href="registro.php">Registrarse</a></p>
</div>
